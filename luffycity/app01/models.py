...
class Teacher(models.Model):
    ...
    role = models.SmallIntegerField(choices=role_choices, default=0)    # 默认是讲师
    title = models.CharField(max_length=64, verbose_name="职位、职称")   # 职位/职称
    signature = models.CharField(max_length=255, help_text="导师签名", blank=True, null=True)   # 签名
    image = models.CharField(max_length=128)    # 头像
    brief = models.TextField(max_length=1024)   # 简介
